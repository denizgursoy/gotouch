...
//
//	mockgen -source=./manager.go -destination=mockManager.go -package=manager
//
...
func (mr *MockManagerMockRecorder) CreateDirectoryIfNotExist(directoryName any) *gomock.Call {
...
func (mr *MockManagerMockRecorder) CreateFile(reader, path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
