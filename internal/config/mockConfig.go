...
//
//	mockgen -source=./config.go -destination=mockConfig.go -package=config
//
...
func (mr *MockConfigManagerMockRecorder) SetValueOf(key, value any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConfigManagerMockRecorder) UnsetValuesOf(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
